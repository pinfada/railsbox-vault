...
test("la table couvre les ONZE modules où la hiérarchie et la v4 se jouent", () => {
  ...
  // que la migration en fait, ce que la chaîne en fait, ce qu'elle fait du journal de sa SOURCE, et
  // les deux endroits où la règle de clôture se joue — le REPORT des compteurs d'une racine écartée,
  // et celui du compte qu'un VERSEMENT hors transaction rend à la datation.
  ...
  assert.deepEqual(fichiers, [
    ...
    "src/vm/opfs-datation-de-creation.mjs",
