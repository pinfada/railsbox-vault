...
| Coquille de produit (`SEC-ORIGIN-001`) | l'assemblage de la frontière publie ce qu'il coûte, sans seuil — **mesuré depuis #161** : canal privilégié établi en 100 ms (Chromium), 345 ms (Firefox), 560 ms (WebKit) en médiane sur cinq exécutions ; cadre applicatif chargé en 318 ms, 3 879 ms et 761 ms. **Ce qui reste hors gate est dit** : le cycle de vie n'est pas assemblé (#163)                                                                                                                                                                                                                                                                                                                                                                                                   |
