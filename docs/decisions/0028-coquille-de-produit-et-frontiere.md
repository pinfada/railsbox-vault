...
| ------------------------------------------------------------- | -------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `vault.coquille.etat` — état du volume et compte de barrières | application → coquille           | `public/vm/reference-worker-phases-volume.mjs:227` › « `present: etat.present,` » (la seule observation qu'un scénario fait d'un volume avant de s'en servir), `tests/e2e/instantane-reprise.spec.mjs:201` › « `phase: "inspect-volume"` », `src/spike/origin-topology.mjs:118` › « `export function isAllowedAppRequest` » |
