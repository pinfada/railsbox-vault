...
| `SEC-KEY-001`                          | **exercé sous réserve** | RÉSERVE RÉDUITE le 11 septembre 2026 (#182, tranche T2a) : la DEK est désormais une clé maîtresse importée en matériau HKDF, que WebCrypto refuse de passer à AES-GCM, et quatre domaines en descendent — `volume`, `journal`, `instantane`, `archive`. Deux volumes sous la même DEK ne partagent plus aucune clé, et chaque compteur compte toutes les invocations sous sa clé. CE QUI RESTE : la page d'enveloppe et la section de récupération scellent encore sous la DEK (tranche T2b), et le cliquet anti-DEK n'est pas posé. La DURÉE de rétention de la KEK dans le Worker de confiance est BORNÉE depuis #169 (geste « Verrouiller » et délai d'inactivité de dix minutes), et elle est mesurée ; ce que le verrouillage ne couvre pas est écrit avec lui — mémoire du processus, fichier d'échange, copie déjà prise                                                                                                                                                          | `tests/browser/enveloppe-frontiere.spec.mjs`, `tests/browser/coquille-cycle-de-vie.spec.mjs` (le verrouillage par geste et par délai, trois moteurs), `tests/unit/coquille-verrouillage.test.mjs` (l'état, la règle et les bornes du délai)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `SEC-BLOCK-001`                        | **exercé sous réserve** | le format scelle tout, de bout en bout — mais la clé du chemin de BOOT vient encore du harnais, sous jeton. Le constat du 10 septembre 2026 (#182) sur les données associées est CORRIGÉ pour les domaines du volume depuis le 11 septembre : chaque domaine de chaque volume scelle sous sa propre clé dérivée, et le budget annoncé par la spécification est celui que le mécanisme tient                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | `tests/unit/vm-volume-chiffre.test.mjs`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
