...
de bout en bout que sous CHROMIUM, Rails n'ayant jamais répondu dans le guest sous Firefox (cause
non établie par #192) ; et rien n'est su de ce qu'il fait d'une application Rails autre que celle de
référence. **Aucun Service Worker sur l'origine de confiance** : le refus de l'ADR 0030 décision 4
est inchangé, et celui de la coquille de cadre vit sur l'origine APPLICATIVE, où l'ADR 0002
l'autorise nommément — il n'ouvre aucune voie vers la coquille que le port restreint n'ouvre déjà.
