...
export const GESTES_ADMIS = Object.freeze([
  Object.freeze({
    ...
    usage: Object.freeze([
      "public/vm/reference-worker-phases-volume.mjs:291 › « present: etat.present, » — la seule " +
      ...
      'tests/e2e/instantane-reprise.spec.mjs:218 › « phase: "inspect-volume" » — un scénario ' +
  ...
  Object.freeze({
    ...
    usage: Object.freeze([
      ...
      'tests/e2e/parcours-page-rails.spec.mjs:334 › « toHaveText("Application de référence") » — ' +
        "le scénario exige que le cadre porte ce que RAILS rend, et non une place tenante",
      'tests/e2e/parcours-page-rails.spec.mjs:353 › « await servie.locator("#enregistrer")' +
